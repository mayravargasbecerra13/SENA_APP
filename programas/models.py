...
class Programa(models.Model):
    ...
    codigo = models.CharField(max_length=20, unique=True, verbose_name="Código de programa")
    ...
    requisitos_ingresos = models.TextField(verbose_name="Requisitos de Ingreso")
    ...
    class Meta:
        ...
        verbose_name_plural = "Programa de Formación"
        ordering = ['nombre']
